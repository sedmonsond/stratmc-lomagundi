## Timing and magnitude of the Lomagundi carbon isotope excursion
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.15460760.svg)](https://doi.org/10.5281/zenodo.15460760)

This repository contains the data and code required to reproduce the figures and analyses in [Edmonsond & Dyer (2026)](https://www.pnas.org/doi/10.1073/pnas.2512767123). All supplementary data is provided in the `data` folder within the `notebooks` directory. 
